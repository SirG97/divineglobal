    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xlg-9 col-md-12">
                <div class="card">
                    <div class="card-header font-weight-bold setting-header">Preregister a marketer</div>
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST" action="{{ route('manager.marketer.store') }}">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-success">Save marketer email</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table no-wrap">
                            ...
                            @else
                                <tr>
                                    <td colspan="7">
                                        <div class="d-flex justify-content-center">No preregistered marketer in this branch yet</div>
                                    </td>
                                </tr>
                            @endif
